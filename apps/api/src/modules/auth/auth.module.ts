...
@Global()
@Module({
  providers: [AuthService, AuthGuard, AdminGuard, RateLimitService, PasswordResetService, OAuthService, TwoFactorService],
  controllers: [AuthController, AccountSecurityController],
  exports: [AuthService, AuthGuard, AdminGuard, RateLimitService, PasswordResetService, TwoFactorService],
})
