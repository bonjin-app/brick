...
const KO = {
  ...
  "account.identityAdult": "성인",
  "account.identityMinor": "19세 미만",
  "account.identityHint": "성인 상품을 구매하려면 본인인증으로 나이를 확인해야 합니다. 이름·생년월일·전화번호는 저장되지 않습니다.",
  "account.identityStart": "본인인증하기",
  "account.identityRequired": "이 사이트는 본인인증한 회원만 글·댓글·주문을 할 수 있습니다.",
...
const EN: Record<keyof typeof KO, string> = {
  ...
  "account.identityAdult": "Adult",
  "account.identityMinor": "Under 19",
  "account.identityHint": "To buy adults-only products you need to verify your age. Your name, date of birth and phone number are not stored.",
  "account.identityStart": "Verify my identity",
  "account.identityRequired": "On this site only verified members can post, comment and order.",
