  ...
  return (
    <div style={{ maxWidth: 760 }}>
      ...
      <Card id="general" title={t("settings.general")} keys={["site.topbar", "site.topbar_url", "site.name", "site.description", "site.og_image", "site.locale", "site.seo_noindex", "site.maintenance", "site.maintenance_message"]}>
        ...
        <Field label={t("settings.topbar")} hint={t("settings.topbarHint")}>
          <input style={input} placeholder={t("settings.topbarPh")} value={str("site.topbar")} onChange={(e) => set("site.topbar", e.target.value)} />
          <input style={{ ...input, marginTop: 6 }} placeholder="/shop 또는 https://…" value={str("site.topbar_url")} onChange={(e) => set("site.topbar_url", e.target.value)} />
        </Field>
      ...
      <Card id="members" title={t("settings.members")} desc={t("settings.membersDesc")}
        keys={["site.registration_open", "member.nick_change_days", "member.one_person_one_account", "member.identity_required", "member.identity_at_signup", "moderation.denied_names", "moderation.denied_email_domains"]}>
        ...
        <Check k="member.identity_required" label={t("settings.identityRequired")} hint={t("settings.identityRequiredHint")} />
        <Check k="member.identity_at_signup" label={t("settings.identitySignup")} hint={t("settings.identitySignupHint")} />
...
const BOOLEAN_KEYS = new Set(["site.registration_open", "member.one_person_one_account", "member.identity_required", "member.identity_at_signup", "site.seo_noindex", "site.maintenance", "security.require_2fa_for_staff", "system.update_check"]);
