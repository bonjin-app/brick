  ...
  return (
    <div style={{ maxWidth: 760 }}>
      ...
      <Card id="members" title={t("settings.members")} desc={t("settings.membersDesc")}
        keys={["site.registration_open", "member.nick_change_days", "member.one_person_one_account", "member.identity_required", "moderation.denied_names", "moderation.denied_email_domains"]}>
...
const BOOLEAN_KEYS = new Set(["site.registration_open", "member.one_person_one_account", "member.identity_required", "site.seo_noindex", "site.maintenance", "security.require_2fa_for_staff", "system.update_check"]);
