...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/E2E-3249%20passing-2ea043.svg" alt="스모크 테스트 3249개" />
...
E2E 스모크 테스트 — 실제 PostgreSQL과 실제 서버 프로세스로 검증합니다 (총 3,249개 항목):
...
| `smoke-i18n.sh` | 62 | 언어가 실제 렌더를 바꿈 · 즉시 반영 · ko 폴백+로그 · 값은 번역 안 함 · 관리 선언 라벨 · **카드 제목 전수** · **리소스 선언 문자열 전수** · **금액 표기·주문 메일도 언어를 따라간다** · 템플릿 잔해 금지 |
