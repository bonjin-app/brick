...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/E2E-3764%20passing-2ea043.svg" alt="스모크 테스트 3764개" />
...
E2E 스모크 테스트 — 실제 PostgreSQL과 실제 서버 프로세스로 검증합니다 (총 3,764개 항목):
...
| `smoke-migrate.sh` | 169 | 덤프 파싱 · 레벨 매핑 · **비밀번호 보존** · 영카트 상품·주문 · 멱등성 · **문서가 말하는 크기의 덤프를 실제로 받는다(그 예외는 이전 경로에만)** · **여분 필드·관련 링크까지 옮긴다** |
