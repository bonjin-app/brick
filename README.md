...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/E2E-2490%20passing-2ea043.svg" alt="스모크 테스트 2490개" />
...
E2E 스모크 테스트 — 실제 PostgreSQL과 실제 서버 프로세스로 검증합니다 (총 2,490개 항목):
...
| `smoke-starter.sh` | 66 | 유형별 기본 구성 생성 · 홈 렌더 · **모든 메뉴 링크가 404 없이 렌더** · 일반 페이지로 수정 가능 |
