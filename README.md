...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/E2E-4076%20passing-2ea043.svg" alt="스모크 테스트 4076개" />
...
E2E 스모크 테스트 — 실제 PostgreSQL과 실제 서버 프로세스로 검증합니다 (총 4,076개 항목):
...
scripts/          스모크 테스트 40종 + 정적 검사 39종 + OIDC 스텁 + 배포본 생성(build-release.sh)
