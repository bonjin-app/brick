...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/E2E-2946%20passing-2ea043.svg" alt="스모크 테스트 2946개" />
...
E2E 스모크 테스트 — 실제 PostgreSQL과 실제 서버 프로세스로 검증합니다 (총 2,929개 항목):

| 수트 | 항목 | 무엇을 못박는가 |
|---|---:|---|
| `smoke-test.sh` | 68 | 설치 · 인증 · 페이지 · 미디어 · 플러그인 로드 · **공유 이미지·immutable 캐시·압축** · **이미지 최적화·EXIF 제거** · **썸네일 백필** · **og 1200×630 자동 변형** · **업로드 immutable·ETag·304** |
...
| `smoke-storefront.sh` | 114 | 사업자번호 체크섬 · 위시리스트 격리 · 지역비 실수령 · **샘플 상품** · **NEW·BEST 뱃지** |
...
| `smoke-search.sh` | 117 | 비밀글·비공개 게시판 미노출 · ILIKE 이스케이프 · total 정확성 · 0건 기록 · **블록 CSS 미색인** |
...
| `smoke-theme.sh` | 206 | 라이트·다크 두 벌 · 토큰 CSS 주입 차단 · 테마 고치면 캐시 갱신 · 랜딩 블록 · **글 상세의 문서 제목** · **두 번째 테마(editorial) 같은 계약** · **Storefront** · **Boutique** · **미리보기** · **배너 슬라이드** · 퀵메뉴 · **Corporate** · **2단 메뉴** |
