...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/E2E-2909%20passing-2ea043.svg" alt="스모크 테스트 2909개" />
...
E2E 스모크 테스트 — 실제 PostgreSQL과 실제 서버 프로세스로 검증합니다 (총 2,909개 항목):
...
| `smoke-storefront.sh` | 108 | 사업자번호 체크섬 · 위시리스트 격리 · 지역비 실수령 · **샘플 상품** |
...
| `smoke-theme.sh` | 178 | 라이트·다크 두 벌 · 토큰 CSS 주입 차단 · 테마 고치면 캐시 갱신 · 랜딩 블록 · **글 상세의 문서 제목** · **두 번째 테마(editorial) 같은 계약** · **Storefront** · **Boutique** · **미리보기** · **배너 슬라이드** |
