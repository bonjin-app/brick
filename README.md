...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/E2E-2448%20passing-2ea043.svg" alt="스모크 테스트 2448개" />
...
E2E 스모크 테스트 — 실제 PostgreSQL과 실제 서버 프로세스로 검증합니다 (총 2,448개 항목):
...
| `smoke-i18n.sh` | 31 | 언어가 실제 렌더를 바꿈 · 즉시 반영 · ko 폴백+로그 · 값은 번역 안 함 |
