...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/E2E-3801%20passing-2ea043.svg" alt="스모크 테스트 3801개" />
...
E2E 스모크 테스트 — 실제 PostgreSQL과 실제 서버 프로세스로 검증합니다 (총 3,801개 항목):
...
| `smoke-notifications.sh` | 64 | **메일이 꺼져 있어도 알림이 닿는가** · 댓글·문의 답변이 알림함에 남는가 · 머리의 개수 · 열면 읽음 · **남의 알림은 보이지 않는다** · **보여준 것만 읽음** · **이어 읽기** · **보관 기간** · **주문 안내 문자(옵트인)** |
