...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/E2E-3058%20passing-2ea043.svg" alt="스모크 테스트 3058개" />
...
E2E 스모크 테스트 — 실제 PostgreSQL과 실제 서버 프로세스로 검증합니다 (총 3,058개 항목):
...
| `smoke-shop.sh` | 142 | 재고 동시성 · 금액 위조 · 구매 검증 후기 · 비밀 문의 · **사진 후기** · **후기 정렬·사진 필터** · **모바일 구매 바** |
