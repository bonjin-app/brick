...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/E2E-2553%20passing-2ea043.svg" alt="스모크 테스트 2553개" />
...
- **코어 블록** — 제목 · 문단 · HTML · 이미지 · 다단 레이아웃 · 여백 ·
  **랜딩 재료**(히어로 · 특징 카드 · 행동 유도 배너 · FAQ 아코디언 · 알림 · 구분선)
...
E2E 스모크 테스트 — 실제 PostgreSQL과 실제 서버 프로세스로 검증합니다 (총 2,553개 항목):
...
| `smoke-poll.sh` | 102 | 중복 투표 · IP 해시 · 결과 공개 시점 · 집계 오염 · 목록→개별 라우팅 |
...
| `smoke-theme.sh` | 48 | 라이트·다크 두 벌 · 토큰 CSS 주입 차단 · 테마 고치면 캐시 갱신 · 랜딩 블록 · **글 상세의 문서 제목** |
