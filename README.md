...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/E2E-2666%20passing-2ea043.svg" alt="스모크 테스트 2666개" />
...
E2E 스모크 테스트 — 실제 PostgreSQL과 실제 서버 프로세스로 검증합니다 (총 2,666개 항목):
...
| `smoke-board.sh` | 126 | 권한 4단계 · 답변형 · 비밀글 · 첨부 원자성 · XSS · **목록 스킨·썸네일·이전/다음·일괄 작업** |
