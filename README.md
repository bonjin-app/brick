...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/E2E-3313%20passing-2ea043.svg" alt="스모크 테스트 3282개" />
...
E2E 스모크 테스트 — 실제 PostgreSQL과 실제 서버 프로세스로 검증합니다 (총 3,313개 항목):
...
| `smoke-security.sh` | 75 | 캡차 · 레이트리밋 · 결제 위조 · 권한 우회 · **CSP** · **캡차 칸 안내** · **비회원 스팸 방어(재입고·문의 캡차·IP 한도)** | · **비회원 주문이 메일 발사대가 되지 않는다** |
...
scripts/          스모크 테스트 36종 + 정적 검사 15종 + OIDC 스텁 + 배포본 생성(build-release.sh)
