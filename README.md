...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/E2E-2685%20passing-2ea043.svg" alt="스모크 테스트 2685개" />
...
- **기본 테마 — 라이트·다크 두 벌** — 토큰 한 벌을 더 두면 다크가 따라온다.
  ...
  현재 메뉴 표시 · 스킵 링크 · 인쇄 스타일. **로그인·마이페이지도 같은 팔레트**
...
E2E 스모크 테스트 — 실제 PostgreSQL과 실제 서버 프로세스로 검증합니다 (총 2,685개 항목):
...
| `smoke-theme.sh` | 93 | 라이트·다크 두 벌 · 토큰 CSS 주입 차단 · 테마 고치면 캐시 갱신 · 랜딩 블록 · **글 상세의 문서 제목** |
