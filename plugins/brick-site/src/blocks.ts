...
.brick-visit-box{display:flex;gap:0;margin:16px 0;padding:0;border:1px solid var(--color-line, #e4e4ea);border-radius:var(--radius-lg, 10px);overflow:hidden}
...
.brick-banner-item{display:block;text-decoration:none;color:inherit;border-radius:var(--radius-lg, 10px);overflow:hidden}
.brick-banner-item img{width:100%;height:auto;display:block}
.brick-banner-body{line-height:1.7}
.brick-popup{position:fixed;z-index:9000;background:var(--color-bg, #ffffff);border:1px solid var(--color-line, #e4e4ea);border-radius:var(--radius-lg, 12px);box-shadow:0 18px 48px rgba(0,0,0,.22);overflow:hidden;max-width:calc(100vw - 24px)}
