...
const CORE_KO: MessageCatalog = {
  ...
  "editor.emptyBlock": "비어 있는 블록 ({name}) — 오른쪽 설정 칸에서 내용을 채우세요. 공개 화면에는 나오지 않습니다.",
...
const CORE_EN: MessageCatalog = {
  ...
  "editor.emptyBlock": "Empty block ({name}) — fill it in from the settings on the right. It does not appear on the public page.",
...
const CORE_ERROR_EN: MessageCatalog = {
  ...
  "이 사이트는 가입 전 본인인증을 쓰지 않습니다.": "This site does not use identity verification before sign-up.",
